...
Everything here was deployed from **`0xd3fb4e6479749100D876584e7F5c5cC1EEAE51A5`** on Arc Mainnet — [see it on the explorer](https://explorer.arc.io/address/0xd3fb4e6479749100D876584e7F5c5cC1EEAE51A5). ArcMeter cost **0.01900616 USDC** (950,308 gas) to deploy, and the transaction that did it is in that wallet's history.
